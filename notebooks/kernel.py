...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  3 18:06:11 2018
...
datafiles = sorted(glob.glob('WDataFiles/**.csv'))
...
games = pd.concat((datafiles['WNCAATourneyCompactResults'],datafiles['WRegularSeasonCompactResults']), axis=0, ignore_index=True)
...
#Add Seeds
seeds = {'_'.join(map(str,[int(k1),k2])):int(v[1:3]) for k1, v, k2 in datafiles['WNCAATourneySeeds'].values}
#Add 2018
